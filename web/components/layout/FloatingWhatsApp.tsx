          ...
          {contacts.map((contact) => (
            <li key={contact.name}>
              <a
                ...
                className="flex items-center gap-3 rounded-lg border border-white/10 p-4 text-sm text-white/90 transition hover:border-green-500 hover:bg-green-500/10 hover:text-white cursor-pointer"
              >

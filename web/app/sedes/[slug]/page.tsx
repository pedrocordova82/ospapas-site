    ...
    <div className="pb-16">
      ...
      <section className="mx-auto grid w-full max-w-6xl gap-8 px-4 pt-10 sm:px-6 lg:grid-cols-2 lg:px-8">
        <article className="rounded-xl border border-white/10 bg-[color:var(--color-bg-900)] p-6 sm:p-8">
          ...
          <div className="mt-4 space-y-1 text-sm">
            {sede.instagram ? (
              <div className="mt-4 flex flex-wrap items-center gap-2 text-base text-[color:var(--color-text-300)]">
                ...
                <a
                  ...
                  className="break-all text-sm font-medium text-[color:var(--color-gold-500)] hover:underline"
                >
                  {sede.instagram}
                </a>
              </div>
      ...
      {sedeMembers.length > 0 ? (
        <section className="mx-auto w-full max-w-6xl px-4 pt-14 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-5 sm:gap-8 md:grid-cols-3 lg:grid-cols-4">
            {sedeMembers.map((member) => (
              <article key={member.name} className="group">
                ...
                <div className="mt-2 text-center">
                  ...
                  <p className="text-xs font-medium tracking-[0.08em] text-[color:var(--color-gold-500)] sm:text-sm">{member.role}</p>
                </div>
              </article>
            ))}
          </div>

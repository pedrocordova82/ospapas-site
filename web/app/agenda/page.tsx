...
const events: Event[] = [
  ...
  {
    id: "festival-moto-brasil-2026",
    month: "outubro",
    dateLabel: "16 a 18",
    title: "Festival Moto Brasil",
    organizer: "Regional Rio de Janeiro",
    location: "Rio de Janeiro-RJ",
    type: "Evento motociclístico",
  },
  {
    id: "festa-12-anos-mc-os-papas-rj-2026",
    month: "outubro",
    dateLabel: "24",
    title: "Festa em comemoração aos 12 anos do MC Os Papas",
    organizer: "Regional Rio de Janeiro",
    location: "Rio de Janeiro-RJ",
    type: "Aniversário",
  },
  ...
  {
    id: "confraternizacao-fim-de-ano-regional-brasilia-2026",
    month: "dezembro",
    dateLabel: "12",
    title: "Confraternização de Fim de Ano da Regional Brasília",
    organizer: "Regional Brasília",
    location: "Brasília-DF",
    type: "Confraternização",
  },
  {
    id: "confraternizacao-fim-de-ano-tome-acu-2026",
    month: "dezembro",
    dateLabel: "15",
    title: "Confraternização de Fim de Ano de Tomé-Açu",
    organizer: "Regional Tomé-Açu",
...
export const metadata: Metadata = {
  title: "Agenda | MC Os Papas",
  description: "Calendário de encontros, aniversários, ações sociais e eventos motociclísticos do MC Os Papas.",
};
